...
doc_radar:
  counts:
    - description: "four modules — the compiled writ, plus the three derivations it owns"
      glob: pkg/kernels/irregex/src/surface/exec/cold/writ/*.zig
      equals: 4
  sentinels:
    ...
    - description: "binary-detection liveness has one owner, and the writ computes rather than carries"
      file: pkg/kernels/irregex/src/surface/exec/cold/writ/writ.zig
...
# surface/exec/cold/writ — what the patterns decide
