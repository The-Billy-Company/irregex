...
doc_radar:
  paths_exist:
    - pkg/kernels/irregex/src/surface/exec/session/watch/watch.zig
    - pkg/kernels/irregex/src/surface/exec/session/watch/inotify.zig
    - pkg/kernels/irregex/src/surface/exec/session/watch/kqueue.zig
    - pkg/kernels/irregex/src/surface/exec/session/watch/coverage.zig
    - pkg/kernels/irregex/src/surface/exec/session/watch/budget.zig
  sentinels:
    - file: pkg/kernels/irregex/src/surface/exec/session/watch/inotify.zig
      contains: ["pub fn startInotify", "pub fn drainInotifyLocked", "FS_CASEFOLD_FL"]
    - file: pkg/kernels/irregex/src/surface/exec/session/watch/kqueue.zig
...
lives in [`../freshness/`](../freshness) — this folder only decides *whether, and
how narrowly,* that barrier has to walk.
