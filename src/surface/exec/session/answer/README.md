...
doc_radar:
  paths_exist:
    - pkg/kernels/irregex/src/surface/exec/session/answer/answer.zig
    - pkg/kernels/irregex/src/surface/exec/session/answer/request.zig
    - pkg/kernels/irregex/src/surface/exec/session/answer/gather.zig
    - pkg/kernels/irregex/bindings/python/tests/test_classify_parity.py
  sentinels:
    - file: pkg/kernels/irregex/src/surface/exec/session/answer/request.zig
    ...
    - file: pkg/kernels/irregex/src/surface/exec/session/answer/keep.zig
