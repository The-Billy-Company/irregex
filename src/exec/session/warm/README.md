...
| `mirror.zig` | The in-RAM corpus mirror: unchanged members bind to the persisted `content.shard` mmap; changed/new/binary/oversize docs heap-read with cold’s own per-file treatment |
