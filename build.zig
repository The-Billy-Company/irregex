...
pub fn build(b: *std.Build) void {
    ...
    for ([_]Lane{
        ...
        .{ .step = "lowering-rung", .exe = "lowering-rung", .root = "bench/rungs/lowering/bench.zig", .blurb = "Compile-price plane: one compile attributed per stage, the per-occurrence and per-range scaling laws, and the pair space the symbolic gate admits on" },
