...
Run: python3 pkg/kernels/gist/tools/build_unicode_tables.py           # writes the .gen.zig
     python3 pkg/kernels/gist/tools/build_unicode_tables.py --check   # diff-only (drift gate)
"""
...
UCD = HERE / "ucd"
OUT = HERE.parent / "src" / "regex" / "unicode" / "tables.gen.zig"
...
def build() -> str:
    ...
    lines: list[str] = []
    lines.append("//! Code generated by pkg/kernels/gist/tools/build_unicode_tables.py from the")
